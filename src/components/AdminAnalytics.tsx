  ...
  return (
    <div id="analytics-statistics-section" className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <button
          onClick={loadData}
          className="inline-flex items-center gap-1.5 bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 text-xs font-semibold px-3.5 py-2 rounded-xl transition-colors shadow-2xs self-start"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-2">
          ...
          <div className="text-3xl font-extrabold text-slate-900 font-mono">
            {analytics.avgResolutionDays} <span className="text-base font-normal text-slate-500">Days</span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-sm font-bold text-slate-900">Resolution Rate by Category (%)</h3>
              <p className="text-xs text-slate-500">Percentage of complaints resolved across civic domains</p>
            </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-sm font-bold text-slate-900">Operational Status Pipeline</h3>
              <p className="text-xs text-slate-500">Distribution across workflow stages</p>
            </div>
          </div>
